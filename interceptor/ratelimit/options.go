...
type Limiter func(ctx *ghttp.Request) error

// NoopLimiter will do nothing
type NoopLimiter struct{}

// Limit will do nothing
func (l *NoopLimiter) Limit(*ghttp.Request) error {
	return nil
}
...
func (l *ZeroRateLimiter) Limit(*ghttp.Request) error {
...
func (l *tokenBucketLimiter) Limit(ctx *ghttp.Request) error {
	l.delegator.Wait(1)
	return nil
}
...
func (l *leakyBucketLimiter) Limit(ctx *ghttp.Request) error {
	l.delegator.Take()
	return nil
}
